-- =====================================================================
-- RUSH Car Wash — el reporte agrupa con la categoria de Zettle
--
-- Sigue de la 041 y la 042. Unico cambio respecto a la 039: base pasa
-- d.categoria a tipo_de_servicio, para que "Paquetes Especial" caiga en
-- la seccion de encerados sin depender del nombre del producto.
-- =====================================================================
