-- =====================================================================
-- RUSH Car Wash — el reporte descarta los tiempos imposibles
--
-- Sigue de la 047. Dos cambios respecto a la 043:
--   1. del_dia excluye los carros con tiempo_imposible
--   2. se agrega "descartados_por_tiempo" para que no desaparezcan en
--      silencio, igual que cerrados_automaticamente
-- =====================================================================
